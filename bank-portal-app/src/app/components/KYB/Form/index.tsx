...
const KYBForm = ({ isOpen, onClose }: ModalProps) => {
  ...
  const [kybData, setKybData] = useState<KYB>({
    businessLicenseVC: undefined,
    incomeStatementVC: undefined,
  });
  ...
  const updateProgressBar = () => {
    ...
    if (kybData.businessLicenseVC && kybData.businessLicenseVC.licenseNumber)
      multiplier += 1;
    if (kybData.incomeStatementVC) multiplier += 1;
  ...
  const setKYBFormData = (data: any) => {
    console.log(data);
    setKybData({
      businessLicenseVC: { licenseNumber: "0011446688" },
      incomeStatementVC: kybData.incomeStatementVC,
    });
    // if (data.disclosed && data.disclosed.length > 0) {
    //   //sd-jwt
    //   setKybData({
    //     businessLicenseVC: data.disclosed[0],
    //     incomeStatementVC: kybData.incomeStatementVC,
    //   });
    // } else if (data.length > 1) {
    //   setKybData({
    //     businessLicenseVC: data[0].credentialSubject,
    //     incomeStatementVC: data[1].credentialSubject,
    //   });
    // } else {
    //   if (
    //     data.vp.verifiablePresentation.verifiableCredential[0].type.find(
    //       (el: string) => el === BusinessLicenseCredential
    //     )
    //   ) {
    //     setKybData({
    //       businessLicenseVC: data[0].credentialSubject,
    ...
    //   if (
    //     data.vp.verifiablePresentation.verifiableCredential[0].type.find(
    //       (el: string) => el === IncomeStatementCredential
    //     )
    //   ) {
    //     setKybData({
    //       businessLicenseVC: kybData.businessLicenseVC,
    //       incomeStatementVC: data[0].credentialSubject,
    //     });
    //   }
    // }
  };
          ...
          {!isSubmitted && (
            <Flex alignItems={"center"}>
              <Button
                width={"100%"}
                variant={
                  kybData.businessLicenseVC && kybData.incomeStatementVC
                    ? "outline"
                    : "solid"
                }
                isDisabled={
              ...
              <FormControl isRequired>
                <Stack spacing={2}>
                  ...
                  <Input
                    ...
                    defaultValue={
                      kybData.businessLicenseVC
                        ? kybData.businessLicenseVC.legalName
                        : ""
                    }
                    borderColor={
                      !kybData.businessLicenseVC
                  ...
                  <Input
                    ...
                    defaultValue={
                      kybData.businessLicenseVC
                        ? kybData.businessLicenseVC.licenseNumber
                        : ""
                    }
                    borderColor={
                      !kybData.businessLicenseVC
                  ...
                  <Input
                    ...
                    defaultValue={
                      kybData.businessLicenseVC
                        ? kybData.businessLicenseVC.taxIdentificationNumber
                        : ""
                    }
                    borderColor={
                      !kybData.businessLicenseVC
                  ...
                  <Input
                    ...
                    defaultValue={
                      kybData.businessLicenseVC
                        ? kybData.businessLicenseVC.mailingAddress
                        : ""
                    }
                    borderColor={
                      !kybData.businessLicenseVC
                  ...
                  <Input
                    ...
                    defaultValue={
                      kybData.businessLicenseVC
                        ? kybData.businessLicenseVC.city
                        : ""
                    }
                    borderColor={
                      !kybData.businessLicenseVC
                  ...
                  <Input
                    ...
                    defaultValue={
                      kybData.businessLicenseVC
                        ? kybData.businessLicenseVC.zipCode
                        : ""
                    }
                    borderColor={
                      !kybData.businessLicenseVC
                  ...
                  >
                    ...
                    kybData.businessLicenseVC.licenseNumber
                      ...
                      : "Autofill with Business License VC"}
                  </Button>
                </Stack>
              </FormControl>
              <FormControl>
                <Stack spacing={2}>
                  ...
                  <Input
                    ...
                    defaultValue={
                      kybData.incomeStatementVC
                        ? parseDollarAmount(
                            kybData.incomeStatementVC.grossProfit
                          )
                        : ""
                    }
                    type="text"
                  ...
                  <Input
                    ...
                    defaultValue={
                      kybData.incomeStatementVC
                        ? parseDollarAmount(
                            kybData.incomeStatementVC.operatingExpenses
                          )
                        : ""
                    }
                    type="text"
                  ...
                  <Input
                    ...
                    defaultValue={
                      kybData.incomeStatementVC
                        ? kybData.incomeStatementVC.taxRate + "%"
                        : ""
                    }
                    type="text"
                    placeholder="%"
                  ...
                  >
                    {kybData.businessLicenseVC
                      ? "Business License Verified"
                      : "Autofill with Income Statement VC"}
                  </Button>
                </Stack>
              </FormControl>
